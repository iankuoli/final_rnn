...
class RNN(object):
    ...
    def __init__(self, input, n_in, n_hidden, n_out, activation=T.tanh,
        ...
        # See: http://groups.google.com/group/theano-dev/browse_thread/thread/3930bd5a6a67d27a
    ...
    def nll_multiclass(self, y):
        ...
        #
        # T.log(self.p_y_given_x) is a matrix of Log-Probabilities (call it LP) with one row per example and one column
        # per class
        #
